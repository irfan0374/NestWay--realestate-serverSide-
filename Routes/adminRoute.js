...
const { adminVerification, userList, partnerList, partnerBlock, userBlock, findPartner, kycApproval, getProperty, findProperty, approvalProperty,premiumUSer,adminDashboard } = require('../Controller/adminController')
...
adminRoute.get('/Dashboard', adminTokenVerified, adminDashboard)
